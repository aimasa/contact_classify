import re
import numpy as np
from entity_extraction import NER_pre_data, normal_param
...
def txtpad_use_bert(txt_list, length):
    ...
    bert_model = load_trained_model_from_checkpoint(normal_param.config_path, normal_param.checkpoint_path,
                                                    seq_len=None)
